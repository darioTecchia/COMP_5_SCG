; ModuleID = 'test_files/test.c'
source_filename = "test_files/test.c"
...
define i32 @main() local_unnamed_addr #0 {
  ...
  %3 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0), i32 %2)
  ret i32 0
}

; Function Attrs: norecurse nounwind readnone uwtable
define i32 @conta(i32* nocapture readnone) local_unnamed_addr #1 {
  ret i32 2
}
