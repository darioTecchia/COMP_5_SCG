; ModuleID = 'test_files/summer.c'
source_filename = "test_files/summer.c"
...
@.str.2 = private unnamed_addr constant [19 x i8] c"la somma risulta: \00", align 1
...
define i32 @main() local_unnamed_addr #0 {
  ...
  %6 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i64 0, i64 0))
  %7 = load i32, i32* @result, align 4, !tbaa !2
  %8 = tail call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str, i64 0, i64 0), i32 %7)
  ret i32 0
}
...
define i32 @add(i32, i32) local_unnamed_addr #2 {
  %3 = add nsw i32 %1, %0
  ret i32 %3
}
